        ...
        {inHub && (
          <>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="pointer-events-auto grid h-9 w-9 place-items-center border border-void-red/40 bg-black/40 text-void-ash transition hover:border-void-red hover:text-white"
                >
                  {soundMuted ? <IconMuted /> : <IconSound />}
                </button>
                <button
                  onClick={() => setCartOpen(true)}
                  className="pointer-events-auto flex items-center gap-2 border border-void-red/40 bg-black/40 px-3 py-2 font-mono text-[10px] tracking-widest text-white transition hover:border-void-red hover:bg-void-red/10"
                >
                  CART
            ...
            <motion.div
              ...
              className="absolute inset-x-0 bottom-5 text-center font-mono text-[10px] tracking-[0.3em] text-void-ash"
            >
              {isTouch ? "TAP A PANEL TO INTERACT" : "CLICK A PANEL TO INTERACT"}
            </motion.div>
          </>
        )}
      </AnimatePresence>
